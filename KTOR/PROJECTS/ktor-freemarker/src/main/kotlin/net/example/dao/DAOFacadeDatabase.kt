...
import net.example.model.Employee
...
class DAOFacadeDatabase(val db: Database): DAOFacade{
    ...
    override fun init() =
        transaction(db) {
            ...
            //Initial data
            val employees = listOf(Employee(1, "Owlette","owlette@example.net", "New York"),
                    Employee(2, "Catboy","catboy@example.net", "New York"),
                    Employee(3, "Grekko","grekko@example.net", "New York"))
